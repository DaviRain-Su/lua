...
NATIVE_CORE_COVERAGE_REQUIREMENTS = {
    ...
    "VAL-NATIVE-014": {
        "min_cases": 4,
        "required_puc_files": ["nextvar.lua"],
        "required_tags": [
            "table:constructor-array-hash",
            "table:indexing-read-write",
            "table:string-bracket-key",
            "table:nil-field-boundary",
            "table:length-boundary",
        ],
    },
    "VAL-NATIVE-015": {
        "min_cases": 3,
        ...
        "required_tags": [
            ...
            "next:nil-termination",
            "next:invalid-key-error",
            "next:pairs-ipairs",
        ],
    },
    "VAL-NATIVE-016": {
        ...
        "required_tags": [
            "globals:_ENV",
            "globals:_G",
            "globals:assignment-visibility",
            "globals:local-shadowing",
            "globals:delete-nil",
        ],
    },
    "VAL-NATIVE-017": {
        "min_cases": 5,
        "required_puc_files": ["events.lua"],
        "required_tags": [
            "metatable:__index",
            "metatable:__newindex",
            "metatable:raw-bypass",
...
NATIVE_PROTECTED_COROUTINE_COVERAGE_REQUIREMENTS = {
    "VAL-ADV2-012": {
        ...
        "required_tags": [
            ...
            "VAL-ADV2-012:expression-binary",
            "VAL-ADV2-012:return-list",
            "VAL-ADV2-012:call-arguments",
        ],
    },
}
...
""",
    ...
    {
        "name": "tables-constructor-indexing-core",
        "puc_file": "nextvar.lua",
        "validates": ["VAL-NATIVE-014"],
        "coverage_tags": [
            "table:constructor-array-hash",
            "table:indexing-read-write",
            "table:string-bracket-key",
        ...
        "description": "array/hash constructors and string/numeric field indexing match stock Lua",
        "source": 'local t = {10, 20, name = "lua", ["dash-key"] = 4, [3] = 30}\nt[2] = 22\nt["extra"] = "ok"\nprint(t[1], t[2], t[3], t.name, t["dash-key"], t.extra, #t)\n',
    },
    {
        "name": "tables-nil-field-overwrite-core",
        "puc_file": "nextvar.lua",
        "validates": ["VAL-NATIVE-014"],
        "coverage_tags": ["table:indexing-read-write", "table:nil-field-boundary", "table:length-boundary"],
        "description": "nil writes make fields absent for reads/traversal while array length observes the first nil hole",
    ...
    },
    {
        ...
        "coverage_tags": ["next:complete-traversal", "next:nil-termination", "next:pairs-ipairs"],
        "description": "pairs/next traverse all non-nil inserted array and hash keys while ipairs stops at the first nil",
        "source": 'local t = {a = 1, b = 2, 10, 20}\nlocal n = 0\nfor _ in pairs(t) do n = n + 1 end\nlocal total = 0\nfor _, v in ipairs(t) do total = total + v end\nlocal k = next(t)\nprint(n, total, k ~= nil)\n',
    },
    {
        "name": "next-explicit-walk-nil-termination-core",
        "puc_file": "nextvar.lua",
        "validates": ["VAL-NATIVE-015", "VAL-NATIVE-014"],
        "coverage_tags": ["next:complete-traversal", "next:nil-termination", "table:constructor-array-hash"],
        "description": "explicit next loop terminates with nil after observing every non-nil key",
        "source": 'local t = {x = 1, y = 2, 5}\nlocal count = 0\nlocal k = nil\nrepeat\n  k = next(t, k)\n  if k ~= nil then count = count + 1 end\nuntil k == nil\nprint(count, k)\n',
    },
    {
        "name": "next-invalid-key-error-core",
        "puc_file": "nextvar.lua",
        "validates": ["VAL-NATIVE-015", "VAL-NATIVE-010"],
        "coverage_tags": ["next:invalid-key-error", "diagnostic:runtime-index"],
        "description": "next rejects keys that are not present in the table with a Lua-compatible runtime failure",
        "source": 'local t = {1, 2}\nprint(next(t, "missing"))\n',
    },
    {
        "name": "globals-env-g-core",
        "puc_file": "nextvar.lua",
        "validates": ["VAL-NATIVE-016"],
        "coverage_tags": ["globals:_ENV", "globals:_G", "globals:assignment-visibility"],
        "description": "default global assignment is visible through unresolved names, _ENV, and _G",
        "source": 'm06_global = 31\nprint(m06_global, _ENV.m06_global, _G.m06_global, _ENV == _G)\nm06_global = nil\n',
    },
    {
        "name": "globals-env-local-shadow-core",
        "puc_file": "nextvar.lua",
        "validates": ["VAL-NATIVE-016"],
        "coverage_tags": ["globals:_ENV", "globals:local-shadowing", "globals:assignment-visibility"],
        "description": "local shadowing and lexical _ENV tables route unresolved reads and writes like stock Lua",
        "source": 'local env = { print = print, value = 5 }\nlocal _ENV = env\nlocal value = 9\nx = value + 1\nprint(value, env.x, x)\n',
    },
    {
        "name": "globals-delete-nil-core",
        "puc_file": "nextvar.lua",
        "validates": ["VAL-NATIVE-016"],
        "coverage_tags": ["globals:_G", "globals:delete-nil", "globals:assignment-visibility"],
        "description": "assigning nil to a global removes the value from later lookup/traversal observations",
        "source": 'm06_delete = "present"\nprint(_G.m06_delete)\nm06_delete = nil\nprint(m06_delete, _G.m06_delete)\n',
    },
    {
        "name": "metatable-index-newindex-core",
        "puc_file": "events.lua",
        "validates": ["VAL-NATIVE-017"],
        "coverage_tags": ["metatable:__index", "metatable:__newindex"],
        "description": "__index and __newindex function events dispatch in ordinary table access",
        "source": 'local log = {}\nlocal t = setmetatable({}, { __index = function(_, key) return "miss:" .. key end, __newindex = function(_, key, value) log[#log + 1] = key .. ":" .. value end })\nprint(t.answer)\nt.answer = "ok"\nprint(log[1], rawget(t, "answer"))\n',
    },
    {
        "name": "metatable-raw-bypass-core",
        "puc_file": "events.lua",
        "validates": ["VAL-NATIVE-017", "VAL-NATIVE-014"],
        "coverage_tags": ["metatable:__index", "metatable:raw-bypass", "table:indexing-read-write"],
        "description": "rawget/rawset/rawequal/rawlen bypass metamethods while ordinary operations dispatch them",
        "source": 'local calls = 0\nlocal t = setmetatable({ present = 1 }, { __index = function() calls = calls + 1; return 99 end })\nprint(rawget(t, "missing"), t.missing, calls)\nrawset(t, "missing", 7)\nprint(rawequal(rawget(t, "missing"), 7), calls, rawlen({1, 2, x = 3}))\n',
    },
    {
        "name": "metatable-arithmetic-comparison-core",
        "puc_file": "events.lua",
        "validates": ["VAL-NATIVE-017"],
        "coverage_tags": ["metatable:arithmetic", "metatable:comparison"],
        "description": "arithmetic and comparison metamethods dispatch for table operands",
    ...
    },
    {
        ...
        "puc_file": "events.lua",
        "validates": ["VAL-NATIVE-017"],
        "coverage_tags": ["metatable:len-concat-call"],
        "description": "__len, __concat, and __call events dispatch for table operands",
        "source": 'local mt = { __len = function() return 12 end, __concat = function(a, b) return a.x .. b.x end, __call = function(_, v) return v + 1 end }\nlocal a = setmetatable({x = "A"}, mt)\nlocal b = setmetatable({x = "B"}, mt)\nprint(#a, a .. b, a(4))\n',
    },
    {
        "name": "metatable-table-index-core",
        "puc_file": "events.lua",
        "validates": ["VAL-NATIVE-017", "VAL-NATIVE-014"],
...
NATIVE_PROTECTED_COROUTINE_CASES = [
    ...
    },
    {
        ...
        "puc_file": "coroutine.lua",
        "description": "nested Lua calls preserve suspended callee and caller frames so pending local assignments and returns continue after resume",
        "validates": ["VAL-ADV2-012"],
        "coverage_tags": ["coroutine.lua", "nested-calls", "frame-stack", "pending-assignment", "pending-return"],
        "source": 'local function inner(x)\n  local y = coroutine.yield(x + 1)\n  return y + 2\nend\nlocal function outer(a)\n  local z = inner(a)\n  return z + 3\nend\nlocal co = coroutine.create(outer)\nprint(coroutine.resume(co, 4))\nprint(coroutine.resume(co, 7))\nprint(coroutine.status(co))\n',
    },
    {
        "name": "coroutine-vararg-multivalue-resume",
        "puc_file": "coroutine.lua",
        "description": "varargs and multiple yielded/resumed values survive a yield boundary with Lua-compatible value order and nil preservation",
        "validates": ["VAL-ADV2-012"],
        "coverage_tags": ["coroutine.lua", "vararg-transfer", "multi-return", "nil-preservation", "resume-values"],
        "source": 'local co = coroutine.create(function(...)\n  local a, b = coroutine.yield(select("#", ...), ...)\n  return a, b, select("#", ...), ...\nend)\nprint(coroutine.resume(co, "x", nil, "z"))\nprint(coroutine.resume(co, "r1", "r2"))\n',
    },
    {
        "name": "coroutine-binary-expression-yield",
        "puc_file": "coroutine.lua",
        "description": "yields inside binary expressions resume with pending operands and operators preserved",
        "validates": ["VAL-ADV2-012"],
        "coverage_tags": [
            "coroutine.lua",
            "yield",
            ...
            "binary-expression-yield",
            "VAL-ADV2-012:yield",
            "VAL-ADV2-012:resume",
            "VAL-ADV2-012:expression-binary",
        ],
        "source": 'local co = coroutine.create(function()\n  return 10 + coroutine.yield("right")\nend)\nprint(coroutine.resume(co))\nprint(coroutine.resume(co, 5))\nlocal co2 = coroutine.create(function()\n  return coroutine.yield("left") + 7\nend)\nprint(coroutine.resume(co2))\nprint(coroutine.resume(co2, 8))\n',
    },
    {
        "name": "coroutine-return-list-yield",
        "puc_file": "coroutine.lua",
        "description": "yields inside return expression lists resume with Lua-compatible multivalue adjustment and nil preservation",
        "validates": ["VAL-ADV2-012"],
        "coverage_tags": [
            "coroutine.lua",
            "yield",
        ...
        "source": 'local co = coroutine.create(function()\n  return "a", coroutine.yield("middle"), nil, "d"\nend)\nprint(coroutine.resume(co))\nprint(coroutine.resume(co, "b", "extra"))\nlocal co2 = coroutine.create(function()\n  return "a", coroutine.yield("tail")\nend)\nprint(coroutine.resume(co2))\nprint(coroutine.resume(co2, "b", nil, "d"))\n',
    },
    {
        "name": "coroutine-call-argument-yield",
        "puc_file": "coroutine.lua",
        "description": "yields inside call argument lists resume with argument order, nil preservation, and final-position multivalue behavior",
        "validates": ["VAL-ADV2-012"],
        "coverage_tags": [
            "coroutine.lua",
            "yield",
        ...
        "source": 'local function pack(...)\n  return select("#", ...), ...\nend\nlocal co = coroutine.create(function()\n  return pack("a", coroutine.yield("middle"), nil, "d")\nend)\nprint(coroutine.resume(co))\nprint(coroutine.resume(co, "b", "extra"))\nlocal co2 = coroutine.create(function()\n  return pack("a", coroutine.yield("tail"))\nend)\nprint(coroutine.resume(co2))\nprint(coroutine.resume(co2, "b", nil, "d"))\n',
    },
    {
        "name": "coroutine-call-statement-argument-yield",
        "puc_file": "coroutine.lua",
        "description": "standalone call statements with yielding arguments resume the pending call, preserve nil/multivalue argument behavior, and continue with following statements",
        "validates": ["VAL-ADV2-012"],
        "coverage_tags": [
            "coroutine.lua",
            "yield",
        ...
        "source": 'local first_n, first_a, first_b, first_c, first_d\nlocal second_n, second_a, second_b, second_c, second_d\nlocal function sink(...)\n  if first_n == nil then\n    first_n = select("#", ...)\n    first_a, first_b, first_c, first_d = ...\n  else\n    second_n = select("#", ...)\n    second_a, second_b, second_c, second_d = ...\n  end\nend\nlocal co = coroutine.create(function()\n  sink("a", coroutine.yield("middle"), nil, "d")\n  sink("a", coroutine.yield("tail"))\n  return first_n, first_a, first_b, first_c, first_d, second_n, second_a, second_b, second_c, second_d, "done"\nend)\nprint(coroutine.resume(co))\nprint(coroutine.resume(co, "b", "extra"))\nprint(coroutine.resume(co, "b", nil, "d"))\nprint(coroutine.status(co))\n',
    },
    {
        "name": "coroutine-protected-frame-yield",
        "puc_file": "coroutine.lua",
